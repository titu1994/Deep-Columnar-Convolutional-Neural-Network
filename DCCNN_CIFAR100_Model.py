...
fork12 = conv(init, nb_filters_1, nb_conv_init, nb_conv_init, repeat=1)
...
fork34 = conv(bn2, nb_filters_3, nb_conv, nb_conv_mid)
fork34 = conv(fork34, nb_filters_3, nb_conv_mid, nb_conv)
fork35 = conv(bn2, nb_filters_3, nb_conv_mid, nb_conv)
fork35 = conv(fork35, nb_filters_3, nb_conv, nb_conv_mid)
merge3 = merge([fork31, fork32, fork33, fork34, fork35, ], mode='concat', concat_axis=1)
conv_pool3 = conv(merge3, nb_filters_2, nb_conv_mid, nb_conv_mid, subsample=(2,2))
dropout = Dropout(0.5, name='dropout')(conv_pool3)

flatten = Flatten()(dropout)
output = Dense(100, activation="softmax",name='output (softmax)')(flatten)
